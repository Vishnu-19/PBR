...
"{\n"  
     "vec2 Xi = Hammersley(i, SAMPLE_COUNT);\n"
       ...
       "R= reflect(-H,N);\n"
        ...
        "vec3 numerator    = texture(cubeMapTex,R).rgb*D* G * F *sinT; \n"
...
unsigned int tempLoc= glGetUniformLocation(shaderProgram, "temp");
       view = glm::lookAt(glm::vec3(camX, camY, camZ), glm::vec3(0.0, 0.0, 0.0), glm::vec3(0.0, 1.0, 0.0));
        ...
        vec3 albedo = vec3(0.447f, 0.157f, 0.118f);
    ...
    glm::mat4 model = glm::mat4(1.0f);
       ...
       glActiveTexture(GL_TEXTURE0);
        glBindTexture(GL_TEXTURE_CUBE_MAP, cubemapTexture);
         ...
         albedo = vec3(0.8314f, 0.6863f, 0.2157f);
       glUniform3fv(albedoLoc, 1, glm::value_ptr(albedo));
        glUniformMatrix4fv(viewLoc, 1, GL_FALSE, glm::value_ptr(view));
        temp=1;
        glUniform3fv(viewPosLoc, 1, glm::value_ptr(camPos));
       glUniform1i(tempLoc,temp);
        ...
        model = glm::translate(mat4(1.0f), glm::vec3(-0.4f, -0.2f, 0.0f));
